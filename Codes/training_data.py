...
reynolds_numbers = {
    # 93: "LM_Couette_R0093_100PI_RSTE",
    # 500: "LM_Couette_R0500_100PI_RSTE",
    93: "LM_Couette_R0093_020PI_RSTE",  
    500: "LM_Couette_R0500_020PI_RSTE"
}
...
# master_df.to_excel('100PI.xlsx', index=False, float_format="%.18f")
master_df.to_excel('20PI.xlsx', index=False, float_format="%.18f")
